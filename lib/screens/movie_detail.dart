                    ...
                    Container(
                      decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                              ...
                              colors: [
                                widget.themeData.canvasColor,
                                widget.themeData.canvasColor.withOpacity(0.3),
                                widget.themeData.canvasColor.withOpacity(0.2),
                                widget.themeData.canvasColor.withOpacity(0.1),
                              ],
                              stops: const [
                                0.0,
                                0.25,
                    ...
                    child: SizedBox(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            color: widget.themeData.primaryColor,
                            border: Border.all(
                                color: widget.themeData.canvasColor, width: 3),
